...
import { UserInfoCardShell } from "./user-info-card-shell";
...
export function UserInfoCard({ user }: UserInfoCardProps) {
  ...
  return (
    <UserInfoCardShell extraActions={extraActions}>
      {fields.map(({ name, label, mono, icon }) => (
        <UserInfoField icon={icon} key={name} label={label} mono={mono}>
          {userData[name]}
        </UserInfoField>
      ))}
    </UserInfoCardShell>
